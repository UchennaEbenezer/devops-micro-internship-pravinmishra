...
![dmi](./screenshots/assignment-04/S3.1.PNG)

![dmi](./screenshots/assignment-04/S3.2.PNG)
...
![dmi](./screenshots/assignment-04/S17.PNG)

---

#### Screenshot 18 — Nginx configuration snippet showing the `/api/` reverse proxy

![dmi](./screenshots/assignment-04/S18.PNG)
